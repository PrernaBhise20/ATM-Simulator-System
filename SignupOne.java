...
public class SignupOne extends JFrame implements ActionListener {
    ...
    SignupOne(){
        ...
        fname.setBounds(100,130,180,20);
        add(fname);
        
        fnameTextField =new JTextField();
        fnameTextField.setFont(new Font("Raleway",Font.BOLD,18));
        fnameTextField.setBounds(300,130,400,30);
        add(fnameTextField);
       ...
       dateChooser.setBounds(300,170,400,30);
        ...
        gender.setBounds(100,210,200,30);
        add(gender);

         male=new JRadioButton("Male");
        male.setBounds(300,210,100,30);
       male.setBackground(Color.WHITE);
        add(male);
        
         female=new JRadioButton("Female");
        female.setBounds(450,210,100,30);
        ...
        emailTextField.setBounds(300,250,400,30);
        add(emailTextField);
      ...
      married.setBackground(Color.WHITE);
        ...
        unmarried.setBounds(450,290,100,30);
        ...
        addressTextField.setBounds(300,330,400,30);
